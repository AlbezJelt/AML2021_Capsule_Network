...
def efficient_capsnet_graph(input_shape):
    ...
    class_caps = FCCaps(2,16)(x)

    
    digit_caps_len = Length(name='length_capsnet_output')(class_caps)

    return tf.keras.Model(inputs=inputs,outputs=[class_caps,digit_caps_len], name='Efficient_CapsNet')
