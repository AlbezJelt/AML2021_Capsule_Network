...
import src.models.em_routing as em
...
def conv_caps(activation_in,
    ...
    with tf.compat.v1.variable_scope(name) as scope:
        ...
        with tf.compat.v1.variable_scope('votes') as scope:
            ...
            assert spatial_routing_matrix.shape == (
                child_space_2, parent_space_2)
...
def fc_caps(activation_in,
    ...
    with tf.compat.v1.variable_scope(name) as scope:
        ...
        with tf.compat.v1.variable_scope('routing') as scope:
            ...
            spatial_routing_matrix = utl.create_routing_map(
                child_space=1, k=1, s=1)
